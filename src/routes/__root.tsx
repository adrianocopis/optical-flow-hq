...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Demandas Optical — Operação criativa" },
      { name: "twitter:title", content: "Demandas Optical — Operação criativa" },
      { name: "description", content: "Demandas Optical - Setor de Criação" },
      { property: "og:description", content: "Demandas Optical - Setor de Criação" },
      { name: "twitter:description", content: "Demandas Optical - Setor de Criação" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/0vI6yvPruQfifLyJbgaEGBv7VJn2/social-images/social-1780797441954-ICON7.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/0vI6yvPruQfifLyJbgaEGBv7VJn2/social-images/social-1780797441954-ICON7.webp" },
